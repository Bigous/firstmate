...
Codex CLI 0.154.0+ uses the native asynchronous Stop owner and `codex queue`; [`../../../../../docs/watcher-continuity.md`](../../../../../docs/watcher-continuity.md#codex-native-stop-ownership) owns that lifecycle and its live verification entry point.
